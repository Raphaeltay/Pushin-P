...
FWs.names.20<-FWs %>% select(Player, selected) %>% filter(selected == "Yes")
FWs.names.20
...
MFs.names.20<-MFs %>% select(Player, selected) %>% filter(selected == "Yes")
MFs.names.20
...
DFs.names.20<-DFs %>% select(Player, selected) %>% filter(selected == "Yes")
DFs.names.20
...
GKs.names.20<-GKs %>% select(Player, selected) %>% filter(selected == "Yes")
GKs.names.20
